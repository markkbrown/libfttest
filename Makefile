...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/11/27 18:06:43 by jthompki          #+#    #+#              #
#    Updated: 2017/12/04 12:18:12 by jthompki         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a

SRC = ft_atoi.c ft_bzero.c ft_factorial.c ft_fibonacci.c\
	  ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c\
	  ft_islower.c ft_isprime.c ft_isprint.c ft_isspace.c ft_isupper.c\
	  ...
	  ft_strncpy.c ft_strnequ.c ft_strnew.c ft_strnstr.c ft_strrev.c ft_strrchr.c\
	  ft_strsplit.c ft_strstr.c ft_strsub.c ft_strtrim.c ft_tolower.c\
	  ft_toupper.c

OBJ = ft_atoi.o ft_bzero.o ft_factorial.o ft_fibonacci.o\
	  ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o\
	  ft_islower.o ft_isprime.o ft_isprint.o ft_isspace.o ft_isupper.o\
	  ft_itoa.o ft_lstadd.o ft_lstdel.o ft_lstdelone.o ft_lstiter.o ft_lstmap.o\
	  ...
	  ft_putstr.o ft_putstr_fd.o ft_sqrt.o\
	  ...
	  ft_strncpy.o ft_strnequ.o ft_strnew.o ft_strnstr.o ft_strrev.o ft_strrchr.o\
